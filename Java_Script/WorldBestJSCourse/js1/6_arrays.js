...
//! Chaining:
//? forEach: It doesn't return a value, so it cannot be directly chained d with other array methods.
...
const number = [1, 2, 3, 6, 4, 5, 6, 7, 8, 9];
// const result = numbers.indexOf(6);
// console.log(result);
// const result1 = number.lastIndexOf(6);
// console.log(result1);
  ...
  for(let j of arr)
    {
        if(currentElement<j)
        {
            currentElement=currentElement+j;
            j=currentElement-j;
            currentElement=currentElement-j;
        }
    }
